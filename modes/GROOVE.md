...
- **Timing variability** — how long a dip takes. At **off** every rise and fall
  ...
  lurches; no two dips feel quite the same.

Two more things you'll feel rather than read. A deeper dip doesn't take longer,
it ramps _steeper_. And the speed eases into the bottom of a dip instead of
stepping evenly down to it, because a few units of speed matter far more at a
crawl than they do near full — so the slow part of a dip lingers.
