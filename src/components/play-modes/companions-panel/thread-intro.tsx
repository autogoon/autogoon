// The pack's intro, at the top of the transcript: the situation the thread
// opens on, addressed to the person playing. It scrolls with the transcript
// rather than pinning, and it never reaches the model.
